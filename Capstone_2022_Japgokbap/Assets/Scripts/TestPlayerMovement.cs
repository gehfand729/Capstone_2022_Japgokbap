...
//Skill부분만 따로 빼서 원래의 playerMovement에 넣으면됨.
...
public class TestPlayerMovement : MonoBehaviour
{
    ...
    private void Start(){
        // seismWave = GetComponent<SeismWave>();
        // bladeStorm = GetComponent<BladeStorm>();
        ...
        //speed = PlayerManager.instance.moveSpeed;
    }
...
// GameObject go = GameObject.Find("BladeStorm") as GameObject;

// private List<Skill> usableSkillLists;
// private Dictionary<byte, Skill> a;
// private Dictionary<byte, GameObject> b;
    //public List<GameObject> usableSkills = new List<GameObject>();
...
//아래의 스킬들은 임시로 특정 키를 지정하여 사용되게 작성해놓았음. 
    ...
    //     {
    //         PlayerManager.Instance.playerMaxHP -= 10.0f;
    //     }
    // }
    ...
    //         PlayerManager.instance.CalculatorEXP(100.0f);
